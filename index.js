...
app.get('/Task/:tasks_id', async (req, res) => {
    try {
...
app.post('/Task', async(req, res) => {
    try {
        ...
        const insertQuery = `INSERT INTO tasks (task_name) VALUES ('${task_name}') RETURNING *`;
...
app.put('/Task/:tasks_id', async (req, res) => {
    try {
      ...
      // Check for duplicate tasks with the same name and "Pending" status
...
app.delete('/Task/:tasks_id', async(req, res) => {
    try {
        const tasks_id  = req.params.tasks_id;
